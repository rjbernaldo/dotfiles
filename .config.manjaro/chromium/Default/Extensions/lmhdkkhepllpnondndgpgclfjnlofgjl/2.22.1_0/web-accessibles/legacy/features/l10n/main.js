(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["core-js/modules/es6.regexp.split", "core-js/modules/es6.regexp.replace", "core-js/modules/web.dom.iterable", "core-js/modules/es6.object.to-string", "core-js/modules/es6.set"], factory);
  } else if (typeof exports !== "undefined") {
    factory(require("core-js/modules/es6.regexp.split"), require("core-js/modules/es6.regexp.replace"), require("core-js/modules/web.dom.iterable"), require("core-js/modules/es6.object.to-string"), require("core-js/modules/es6.set"));
  } else {
    var mod = {
      exports: {}
    };
    factory(global.es6Regexp, global.es6Regexp, global.webDom, global.es6Object, global.es6);
    global.main = mod.exports;
  }
})(this, function (_es6Regexp, _es6Regexp2, _webDom, _es6Object, _es) {
  "use strict";
  ...
  (function poll() {
    ...
    if (typeof ynabToolKit !== 'undefined' && ynabToolKit.pageReady === true && typeof Ember !== 'undefined') {
      ynabToolKit.l10n = function () {
        ...
        return {
          ...
          budgetHeader() {
            ...
            contentSetter.setArray([l10n['budget.fundsFor'].replace('{{currentMonth}}', dateInfo.currentMonthName), l10n['budget.overspentIn'].replace('{{previousMonth}}', dateInfo.previousMonthName), l10n['budget.fundedIn'].replace('{{currentMonth}}', dateInfo.currentMonthName)]);
          },

          observe(changedNodes) {
            ynabToolKit.l10n.invoke(); // User has returned back to the budget screen
            ...
            if (changedNodes.has('modal-overlay ynab-u modal-account-calendar active') || changedNodes.has('accounts-calendar')) {
      ...
      ynabToolKit.l10n.budgetHeader(); // Rerender sidebar and content views on page load.
