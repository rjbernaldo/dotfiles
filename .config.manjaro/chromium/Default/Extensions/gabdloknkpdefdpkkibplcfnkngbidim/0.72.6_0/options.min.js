...
!function(){var e=/^(http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/,t={CONNECTION_DEFAULTS:[{id:"url",def:"",opts:{validate:function(t){return t?e.test(t):t},validate_message:"Invalid server url.",required:!0,scrubber:function(e){return e?("http"!=e.substring(0,4)&&(e="http://"+e),e):""}}},{id:"pass",def:"",opts:{}}],DEFAULTS:[{id:"inpage_notification",def:!0,opts:{}},{id:"enable_context_menu",def:!0,opts:{}},{id:"enable_context_menu_with_options",def:!0,opts:{}},{id:"enable_keyboard_macro",def:!0,opts:{}},{id:"enable_leftclick",def:!0,opts:{}},{id:"send_cookies",def:!0,opts:{}},{id:"link_regex",def:"",opts:{}},{id:"enable_debug_logging",def:!1,opts:{}}],LABEL_DEFAULTS:[{id:"default_label",def:"",opts:{}}],validate_element:function(e,t){var n=e.id,o="",i={err:!1,mu:null};if(!t.length)return i;if(t.is("input[type=checkbox]"))t.prop("checked")&&(o=t.val());else if(t.is("input[type=text]")||t.is("input[type=password]"))o=t.val();else{if(!t.is("select"))throw"unknown element";o=t.val()}var a=$("<span/>",{class:"validation-message"}),s=e.opts.validate,r=e.opts.validate_message,l=e.opts.required,c=e.opts.scrubber;return a.css("color","red"),c&&(o=c(o)),!l||"undefined"!=typeof o&&null!==o&&""!==o?s&&!s(o)?(a.html(r||"Invalid entry."),t.after(a),i.err=!0):i.mu={opt_id:n,opt_val:o}:(a.html("Required field."),t.after(a),i.err=!0),i},save:function(){$(".validation-message").empty(),$("#save_options").text("Saving...");var e=!1,n=[],o=[];$("#connection-info .connection-container").each(function(){for(var n=$(this),i={},a=!1,s=0,r=t.CONNECTION_DEFAULTS.length;s<r;s++){var l=t.CONNECTION_DEFAULTS[s].id,c=n.find('[name="'+l+'"]'),d=t.validate_element(t.CONNECTION_DEFAULTS[s],c);e||a||d.err?e=!0:d.mu&&(i[d.mu.opt_id]=d.mu.opt_val)}a||o.push(i)}),o.length&&n.push({opt_id:"connections",opt_val:JSON.stringify(o)});for(var i=0,a=t.DEFAULTS.length;i<a;i++){var s=t.DEFAULTS[i].id,r=$("#"+s),l=t.validate_element(t.DEFAULTS[i],r);l.err?e=!0:l.mu&&n.push(l.mu)}for(var i=0,a=t.LABEL_DEFAULTS.length;i<a;i++){var s=t.LABEL_DEFAULTS[i].id,r=$("#"+s),l=t.validate_element(t.LABEL_DEFAULTS[i],r);l.err?e=!0:l.mu&&n.push(l.mu)}if(!e)for(var c=0,d=n.length;c<d;c++){var p=n[c];localStorage.setItem(p.opt_id,p.opt_val)}$("#save_options").text("Save"),chrome.runtime.sendMessage(chrome.runtime.id,{method:"settings-changed"})},setOptionValues:function(e){for(var t=0,n=e.length;t<n;t++){var o=e[t].id,i=null===localStorage.getItem(o)?e[t].def:localStorage.getItem(o),a=$("#"+o);if("undefined"!=typeof i&&a.length)if(a.is("input[type=checkbox]"))a.prop("checked",!!i);else if(a.is("input[type=text]")||a.is("input[type=password]"))a.val(i);else{if(!a.is("select"))throw console.error(a,o),"unknown element";a.val(i)}}},restore:function(){communicator.sendMessage({method:"plugins-getinfo"},function(e){var n=e.value.Label,o=$.templates($("#labels-options-tmpl").html()),i=$("#labels-options").empty(),a={labelsEnabled:!!n,labelsCreated:!!n&&!!n.length,labels:n};i.append(o(a)),t.setOptionValues(t.LABEL_DEFAULTS)});var e=[{}];try{e=JSON.parse(localStorage.connections)}catch(e){}e=$.isArray(e)?e:[{}];var n=$.templates($("#connection-string-tmpl").html()),o=$("#connection-info").empty();e.forEach(function(e,i){for(var a={index:i},s=0,r=t.CONNECTION_DEFAULTS.length;s<r;s++){var l=t.CONNECTION_DEFAULTS[s].id,c="undefined"==typeof e[l]||null===e[0]?t.CONNECTION_DEFAULTS[s].def:e[l];a[l]=c}o.append(n(a))}),t.setOptionValues(t.DEFAULTS)},clear:function(){localStorage.clear(),t.restore(),communicator.sendMessage({method:"settings-changed"})}};communicator.observeConnect(function(){t.restore(),$("#version").html(chrome.runtime.getManifest().version),$(document).on("change","input.option_field[type=checkbox]",t.save).on("blur","input.option_field:not([type=checkbox])",t.save).on("change","select.option_field",t.save),$("#enable_leftclick")[0].addEventListener("change",function(){$("#link_regex").prop("disabled",!this.checked)},!1),$("#link_regex").prop("disabled",!$("#enable_leftclick").prop("checked")),$("#reset_options").on("click",t.clear),$("#save_options").on("click",t.save),$("#manage_extension")[0].addEventListener("click",function(){chrome.tabs.create({url:"chrome://extensions/?id="+chrome.runtime.id})})}).init(!!chrome.runtime.id)}(document);
//# sourceMappingURL=maps/options.min.js.map
