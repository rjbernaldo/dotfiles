...
window.Template = (function(document) {
	...
	Template.prototype.cloneFirst = function(context) {
		context = (context) ? context : this.template.parentNode;

		children(this.content, attributes.bind(this));
		children(this.content, content.bind(this));

		return context.insertBefore(this.content, context.firstChild);
	}
