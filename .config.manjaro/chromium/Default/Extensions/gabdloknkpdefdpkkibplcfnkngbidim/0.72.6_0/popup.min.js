...
!function(){communicator.observeConnect(function(){communicator.sendMessage({method:"storage-get-connections"},function(r){var e;try{e=r.value[0].url}catch(r){}e?($("#server-url").removeClass("hidden"),$("#server-url-link").attr("href",e)):($("#server-url").addClass("hidden"),$("#server-url-link").attr("href",null),$("#reminder").innerHTML="Don't forget to configure your server info first!"),$("a").on("click",function(){$(this).blur()})})}).init("popup")}();
