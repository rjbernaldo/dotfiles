...
window.GEMINI_NONCE = 0
window.GEMINI_NONCE_OFFSET = 0
...
function Gemini() {
	...
	function* getNonce() {
		...
		if (window.GEMINI_NONCE != nonce) {
			window.GEMINI_NONCE_OFFSET = -1
		}

		window.GEMINI_NONCE = nonce
		window.GEMINI_NONCE_OFFSET++

		nonce += window.GEMINI_NONCE_OFFSET
