...
beautiful.init("/home/rj/.config/awesome/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local names = { "main", "browser", "misc", "editor", "terminal" }
    local l = awful.layout.suit;
    awful.tag(names, s, awful.layout.layouts)
    -- awful.tag({ "main", "browser", "misc", "editor", "terminal" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "space",     function () awful.util.spawn_with_shell("/usr/bin/dmenu_run") end,
...
for s = 1, screen.count() do screen[s]:connect_signal("arrange", function ()
  ...
  for _, c in pairs(clients) do
    ...
    if c.maximized then
      ...
      -- add borders even when maximised
...
beautiful.collision_focus_bg_center = "#000000"
beautiful.collision_focus_border_color = "#000000"
beautiful.collision_focus_bg = "#00000000"
beautiful.collision_focus_fg = "#00000000"
beautiful.collision_shape_width = 1.0
beautiful.collision_shape_height = 1.0
