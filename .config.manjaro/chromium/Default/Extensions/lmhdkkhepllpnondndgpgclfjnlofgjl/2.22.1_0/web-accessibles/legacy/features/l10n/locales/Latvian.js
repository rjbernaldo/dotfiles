(function (global, factory) {
  ...
  ynabToolKit.l10nData = {
    ...
    "app.back": "Atpakaļ",
    "app.edit": "Labot",
    "app.saveAndAddAnother": "Saglabāt un pievienot",
    "app.saveCopy": "Saglabāt kopiju",
    "app.didYouMean": "Vai domāji {{word}}?",
    "app.from": "No",
    "app.to": "Līdz",
    "app.move": "Pārvietot",
    "app.show": "Rādīt",
    ...
    "app.account": "Konts",
    "app.date": "Datums",
    "app.payee": "Darījuma saņēmējs",
    "app.memo": "Piezīmes",
    "app.amount": "Summa",
    "app.next": "Nākamais",
    "app.complete": "Pabeigts",
    "app.refresh": "Refresh",
    "app.skip": "Izlaist",
    "app.saveAndNext": "Saglabāt un Nākamais",
    "app.undo": "Undo",
    "app.redo": "Redo",
    "app.remove": "Remove",
    ...
    "aria.checkAllTransactions": "Atzīmēt visus maksājumus",
    "aria.checkAllPayees": "Check all payees",
    "aria.checkThisTransaction": "Atzīmēt šo maksājumu",
    "aria.selectName": "Select {{name}}",
    "aria.uncheckAll": "Uncheck all",
    "loading.loading": "Ielādē {{{item}}}",
    ...
    "months.Nov": "Nov",
    "months.Dec": "Dec",
    "months.January": "Janvāris",
    "months.February": "Februāris",
    "months.March": "Marts",
    "months.April": "Aprīlis",
    "months.June": "Jūnijs",
    "months.July": "Jūlijs",
    "months.August": "Augusts",
    "months.September": "Septembris",
    "months.October": "Oktobris",
    "months.November": "Novembris",
    "months.December": "Decembris",
    "error.unknown": "Bitīt'matos kļūda!",
    "modal.categories": "Budžeta Kategorijas",
    "modal.noCategoriesFound": "Nav kategoriju.",
    "modal.payees": "Naudas saņēmēji",
    ...
    "modal.addCategory": "Pievienot Kategoriju",
    "modal.split": "Dalīt (Vairākās kategorijās)",
    "modal.accounts": "Konti",
    "modal.paymentOrTransfer": "Payment or Transfer",
    "modal.budgetAccounts": "Budget Accounts",
    "modal.trackingAccounts": "Sekojamie konti",
    "modal.noAccountsFound": "Neviens konts nav atrasts.",
    "modal.deleteAccount": "Dzēst kontu",
    "modal.delete": "Dzēst",
    "modal.closeAccount": "Slēgt kontu",
    "modal.reopenAccount": "Atkārtoti atvērt",
    "modal.budgetSettings": "Budget Settings",
    "modal.newBudget": "New Budget",
    "modal.creatingBudget": "Tiek veidot budžets...",
    "modal.openBudget": "Open Budget",
    "modal.managePayees": "Labot maksājumu saņēmējus",
    "modal.manageConnections": "Manage Connections",
    "modal.saveACopy": "Saglabāt kopiju",
    "modal.makeAFreshStart": "Sāksim visu no baltas lapas",
    ...
    "modal.startingFresh": "Sākam no jauna...",
    ...
    "modal.myAccount": "Mans konts",
    "modal.logOut": "Log Out",
    "modal.createBudgetBtn": "Izveidotu budžetu",
    "modal.createAccountBtn": "Pievienot kontu",
    "modal.saveBudgetSettingsBtn": "Lietot iestatījumus",
    "modal.filterTransactions": "Atlasīt Maksājumus",
    "modal.coverThisOverSpendingWith": "Nosegt šo pārtērēto ar",
    ...
    "modal.approveTransaction": "Apstiprināt Maksājumu",
    "modal.rejectTransaction": "Noraidīt Maksājumu",
    ...
    "modal.ok": "OK",
    "modal.deleteReconciledTransaction": "Dzēst Apstiprinātu Maksājumu",
    ...
    "modal.selectAll": "Atzīmēt visu",
    "modal.selectNone": "Neizvēlēties",
    ...
    "modal.subscribeNow": "Abonē tagad.",
    ...
    "modal.newCategoryGroup": "Jauna Kategoriju Grupa",
    "modal.newCategoryGroupName": "Jauna Kategorijas Grupa:",
    "modal.yourFiltersHaveBeenTurnedOff": "Some filters had to be changed to show the transaction.",
    "modal.disconnected.header": "Ū-ā!",
    ...
    "modal.disconnected.retryBtn": "Mēģināt vēlreiz",
    "modal.disconnected.reconnectingBtn": "Pieslēdzas...",
    "modal.matchedTransaction.title": "Sakrītošie Maksājumi",
    "modal.matchedTransaction.date": "Datums",
    "modal.matchedTransaction.payee": "Maksājuma saņēmējs",
    "modal.matchedTransaction.memo": "Piezīmes",
    "modal.matchedTransaction.approveBtn": "Apstiprināt Maksājumu",
    "modal.matchedTransaction.rejectBtn": "Noraidīt Maksājumu",
    "modal.matchedTransaction.unMatchBtn": "NEsakrītošie Maksājumi",
    ...
    "modal.hiddenCategories.clickACategoryToShowIt": "Spied, lai slēptu kategoriju",
    "modal.hiddenCategories.showAllHiddenCategories": "Parādīt visas slēptās kategorijas",
    "modal.hiddenCategories.noHiddenCategories": "Nav slēptu kategoriju",
    "modal.debtActivity.spending": "Izdevumi",
    "modal.debtActivity.spendingTitle": "Šīs kartes kopējie izdevumi šajā mēnesī.",
    ...
    "modal.debtActivity.totalSpending": "Kopējie izdevumi",
    "modal.debtActivity.totalSpendingTitle": "Šīs kartes kopējie izdevumi un ienākumi šajā mēnesī.",
    ...
    "modal.debtActivity.totalActivity": "Kopējā aktivitāte",
    ...
    "modal.addAccount.budget": "Budžets",
    "modal.addAccount.tracking": "Sekošana",
    "modal.addAccount.newAccount": "Jauns konts",
    "modal.addAccount.editAccount": "Authenticate {{account}}",
    "modal.addAccount.somethingWrong": "Kaut kas nogājis greizi.",
    "modal.addAccount.account": "KONTS",
    "modal.addAccount.balance": "BILANCE",
    "modal.reconcile.isYourCurrentAccountBalance": "Vai <strong>esošā</strong> konta bilance ir",
    "modal.reconcile.howDoIFindMyAccountBalance": "How do I find my account balance?",
    "modal.reconcile.accountReconciled": "Konts vienādots!",
    "modal.reconcile.reconcilationDance": "Laiks vienādošanas dejai.",
    "modal.reconcile.enterYourCurrentBalance": "Ievadi <strong>pašreizējo</strong> bilanci:",
    "modal.reconcile.thereIsADifference": "Ir {{difference}} starpība.",
    ...
    "directImportUpgrade.maybeLater": "Varbūt vēlāk",
    ...
    "accountTypes.Savings": "Noguldījumi",
    "accountTypes.Cash": "Skaidra nauda",
    "accountTypes.CreditCard": "Kredītkarte",
    ...
    "closeAccount.transferMemo": "Slēdz kontu.",
    "budgetSettings.budgetNameLabel": "Budžeta nosaukums:",
    "budgetSettings.currencyLabel": "Valūta:",
    "budgetSettings.currencyFormatLabel": "Skaitļu formāts:",
    "budgetSettings.currencySymbolPlacementLabel": "Valūtas novietojums:",
    "budgetSettings.currencySymbolPlacementBeforeLabel": "Pirms summas",
    "budgetSettings.currencySymbolPlacementAfterLabel": "Pēc summas",
    "budgetSettings.currencySymbolPlacementNoneLabel": "Nerādīt valūtu",
    "budgetSettings.dateFormatLabel": "Datuma formāts:",
    "budgetCategory.enterCategoryName": "Ievadīt kategorijas nosaukumu",
    ...
    "sidebar.budget": "Budžets",
    "sidebar.reports": "Pārskati",
    "sidebar.accounts": "Visi konti",
    "sidebar.onBudget": "BUDŽETS",
    "sidebar.offBudget": "SEKOJAM LĪDZ",
    "sidebar.closed": "SLĒGTS",
    "sidebar.addAccount": "Pievienot kontu",
    "sidebar.noAccounts": "Nav kontu",
    ...
    "onboarding.showMe": "Parādi!",
    "onboarding.gotIt": "Sapratu!",
    "onboarding.okay": "Labi!",
    "onboarding.letsGo": "Aiziet!",
    "onboarding.done": "Darīts!",
    "onboarding.start": "Sākam!",
    "onboarding.review": "Pārskats",
    ...
    "onboarding3.youreReady": "Esi gatavs!",
    ...
    "onboarding3.accountBalances": "Kontu atlikumi",
    ...
    "onboarding3.lostAndFound": "Meklē kaut ko?",
    ...
    "onboarding.set-goal.cardTitle": "Nosaki mērķi",
    ...
    "onboarding.schedule-transaction.cardTitle": "Ieplānot maksājumu",
    ...
    "onboarding.move-money.cardTitle": "Pārvietot naudu",
    ...
    "budget.ageOfMoney": "Naudas vecums",
    "budget.ageOfMoneyDays.one": "diena",
    "budget.ageOfMoneyDays.other": "dienas",
    "budget.ageOfMoneyNotAvailable": "???",
    "budget.categoryGroup": "Kategoriju grupa",
    "budget.addCategoryGroup": "Pievienot kategoriju grupu",
    "budget.quickBudget": "Ātrā budžetēšana",
    "budget.debtSnowball": "Parādu sniegabumba",
    "budget.category": "KATEGORIJA",
    "budget.budgeted": "BUDŽETĀ",
    "budget.activity": "ACTIVITY",
    "budget.available": "PIEEJAMS",
    "budget.cc.category": "CREDIT CARD PAYMENTS",
    "budget.cc.budgeted": "BUDGETED",
    "budget.cc.activity": "ACTIVITY",
    "budget.cc.payment": "PAYMENT",
    "budget.uncategorizedTransactions": "NEkategorizēti Maksājumi",
    "budget.hiddenCategories": "Paslēptās kategorijas",
    "budget.fundsFor": "Ienākumi no {{currentMonth}}",
    "budget.incomeFor": "{{currentMonth}} Ienākumi",
    "budget.overspentIn": "Pārtēriņš {{month}}",
    "budget.fundedIn": "Budžetā {{currentMonth}}",
    "budget.fundedInFuture": "Nākotnes budžetā",
    "budget.otherMonthsActivity": "Other Months' Activity",
    "budget.enterANote": "Ievadi piezīmi...",
    ...
    "budget.newCategory": "Jauna Kategorija",
    "budget.newCategoryGroup": "Jauna kategoriju grupa",
    "budget.Uncategorized": "Bez kategorijas",
    "budget.collapseNameCategories": "Collapse {{name}} categories",
    "budget.expandNameCategories": "Expand {{name}} categories",
    "inspector.totalBudgeted": "KOPĀ BUDŽETĀ",
    "inspector.totalIncome": "KOPĒJIE IENĀKUMI",
    "inspector.totalActivity": "KOPĒJAIS APGROZĪJUMS",
    "inspector.totalAvailable": "KOPĀ PIEEJAMS",
    ...
    "inspector.targetBalance": "Mērķa bilance",
    "inspector.targetDate": "Mērķa mēnesis & gads",
    "inspector.monthlyAmount": "Budžeta mērķa summa",
    ...
    "inspector.notes": "Piezīmes",
    "inspector.notesPlaceholder": "Piezīmēt...",
    ...
    "accounts.allAccounts": "Visi konti",
    ...
    "accounts.importTransactions": "Ielādēt",
    "accounts.reconcileAccount": "Reconcile Account",
    "accounts.addTransaction": "Pievienot Maksājumu",
    "accounts.recordPayment": "Record Payment",
    "accounts.account": "ACCOUNT",
    "accounts.date": "DATUMS",
    "accounts.payee": "MAKSĀJUMA SAŅĒMĒJS",
    "accounts.category": "KATEGORIJA",
    "accounts.memo": "PIEZĪME",
    ...
    "accounts.approve": "Apstiprināt",
    "accounts.categorizeAs": "Categorize",
    "accounts.reject": "Noraidīt",
    "accounts.enterInAccountNow": "Ievadīt tagad",
    "accounts.moveToAccount": "Move to Account",
    "accounts.match": "Sakrīt",
    "accounts.unmatch": "Atsaistīt",
    "accounts.delete": "Dzēst",
    "accounts.addAnotherSplit": "Pievienot citu daļu",
    "accounts.amountRemainingToAssign": "Amount remaining to assign",
    "accounts.filter": "Meklētājs",
    "accounts.thismonth": "Šajā mēnesī",
    "accounts.latest3months": "Pēdējie 3 mēneši",
    "accounts.thisyear": "Šogad",
    "accounts.lastyear": "Pagājušais gads",
    "accounts.alldates": "Visi datumi",
    ...
    "accounts.scheduledTransactions": "Ieplānoti Maksājumi",
    "accounts.c": "K",
    "accounts.repeat": "Atkārtot",
    ...
    "accounts.showAllTxnsButtonText": "Parādīt visu.",
    "accounts.clearSearch": "Nodzēst meklēšanu.",
    "accounts.needsACategory": "Trūkst kategorijas",
    "accounts.thisTransactionNeedsACategory": "Šim maksājumam nepieciešama kategorija",
    "accounts.thisTransactionNeedsApproval": "Šo maksājumu nepieciešams apstiprināt",
    ...
    "accounts.categoryNotNeeded": "Kategorija nav nepieciešama",
    "accounts.frequency.Never": "Nekad",
    "accounts.frequency.Daily": "Ikdienu",
    "accounts.frequency.Weekly": "Reizi nedēļā",
    "accounts.frequency.EveryOtherWeek": "Katru otro nedēļu",
    "accounts.frequency.TwiceAMonth": "Divas reizes mēnesī",
    "accounts.frequency.Every4Weeks": "Ik pēc 4 nedēļām",
    "accounts.frequency.Monthly": "Reizi mēnesī",
    "accounts.frequency.EveryOtherMonth": "Katru otro mēnesi",
    "accounts.frequency.Every3Months": "Ik pēc 3 mēnešiem",
    "accounts.frequency.Every4Months": "Ik pēc 4 mēnešiem",
    "accounts.frequency.TwiceAYear": "Divas reizes gadā",
    "accounts.frequency.Yearly": "Reizi gadā",
    "accounts.frequency.EveryOtherYear": "Katru otro gadu",
    ...
    "accounts.notification.noTransactionsToImport": "Nav maksājumu, ko ielādēt.",
    ...
    "reports.totals": "Kopsummas",
    "reports.total": "Kopā",
    "reports.trends": "Trends",
    "reports.average": "Vidējs",
    "reports.spendingTotals": "Izdevumi kopā",
    "reports.totalSpending": "Kopējie izdevumi",
    "reports.spendingTrends": "Spending Trends",
    "reports.forThisTimePeriod": "For this time period",
    "reports.averageSpending": "Vidēji tērēts",
    "reports.perMonth": "Mēnesī",
    "reports.changeInNetWorth": "Change in Net Worth",
    "reports.spending.percentageValue": "{{percentageValue}}% no Kopējā",
    "reports.spending.netInflows": "Net Inflows",
    "reports.categories": "Kategorijas",
    "reports.noCategories": "Nav kategoriju",
    "reports.allCategories": "Visas kategorijas",
    "reports.someCategories": "Some Categories",
    "reports.noPayees": "No Payees",
    "reports.allPayees": "Visi maksājuma saņēmēji",
    "reports.somePayees": "Some Payees",
    "reports.accounts": "Konti",
    "reports.noAccounts": "No Accounts",
    "reports.allAccounts": "Visi konti",
    "reports.someAccounts": "Some Accounts",
    "reports.timeframe": "Timeframe",
    "reports.income": "Income",
    "reports.expense": "Izdevumi",
    "reports.uncategorizedTransactions": "NEkategorizēti Maksājumi",
    ...
    "reports.totalItemName": "Kopā {{itemName}}",
    "reports.inspector.categories": "CATEGORIES",
    "reports.inspector.payees": "PAYEES",
    "reports.inspector.spending": "IZDEVUMI",
    "reports.inspector.month": "MĒNEŠI",
    ...
    "search.needsCategory": "Nepieciešama kategorija",
    ...
    "fileImport.importTransactions": "Ielādēt Maksājumus",
    "fileImport.importTransactionsProgress": "Ielādēts ({{progress}} no {{total}} Kontiem)",
    ...
    "fileImport.transactionsHaveBeenSuccessfullyImported.one": "1 maksājums ir veiksmīgi ielādēts.",
    ...
    "fileImport.noTransactionsToImport": "Nav maksājumu, ko ielādēt",
    "fileImport.transactionsNotShown.one": "1 maksājums netiek atrādīts",
    "fileImport.transactionsNotShown.other": "{{amount}} maksājumi netiek atrādīti",
    ...
    "fileImport.unsupportedFileType": "Neatbalstīts faila veids",
    ...
    "fileImport.zeroTransactionsToImport": "Nulle Maksājumu, ko Ielādēt",
    ...
    "tooltip.budget.budgetedToZero": "Mans draugs, Tu esi burvīgs. Esi katram eiro iedevis darbu.",
    "tooltip.budget.budgetedColumn": "Šajā kolonnā pievieno naudu katrai kategorijai. Šī ir jautrā daļa. Līdz beidzas nauda.",
    ...
    "tooltip.budget.toBudget.overspent": "Kopējais kategorijas pārtēriņš {{month}}",
    "tooltip.budget.toBudget.funded": "Kopējais budžetētais {{currentMonth}}",
    "tooltip.budget.toBudget.fundedInFuture": "Kopējais budžetētais turpmākajiem mēnešiem. Nākotnes Tu Tev būs pateicīgs!",
    "tooltip.budget.toBudget.otherMonthsActivity": "Kopējie ienākumi, pārtēriņš un budžetētais iepriekšējos mēnešos.",
    ...
    "tooltip.undo": "Atcelt pēdējo darbību, ko darīji (YNAB nevis dzīvē).",
