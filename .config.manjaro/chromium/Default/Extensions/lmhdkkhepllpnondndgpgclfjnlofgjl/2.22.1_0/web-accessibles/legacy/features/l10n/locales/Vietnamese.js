(function (global, factory) {
  ...
  ynabToolKit.l10nData = {
    ...
    "app.back": "Quay lại",
    "app.edit": "Sửa",
    "app.saveAndAddAnother": "Lưu và thêm mới",
    "app.saveCopy": "Lưu bản sao",
    "app.didYouMean": "Ý bạn là {{word}}?",
    "app.from": "Từ",
    "app.to": "Đến",
    "app.move": "Di chuyển",
    "app.show": "Hiện",
    ...
    "app.date": "Ngày tháng",
    "app.payee": "Người nhận thanh toán",
    "app.memo": "Ghi chú",
    "app.amount": "Số lượng",
    "app.next": "Tiếp",
    "app.complete": "Hoàn thành",
    "app.refresh": "Refresh",
    "app.skip": "Skip",
    ...
    "months.Nov": "Th 11",
    "months.Dec": "Th 12",
    "months.January": "Tháng một",
    "months.February": "Tháng hai",
    "months.March": "Tháng ba",
    "months.April": "Tháng tư",
    "months.June": "Tháng sáu",
    "months.July": "Tháng bảy",
    "months.August": "Tháng tám",
    "months.September": "Tháng chín",
    "months.October": "Tháng mười",
    "months.November": "Tháng mười một",
    "months.December": "Tháng mười hai",
    "error.unknown": "Một lỗi không rõ đã xảy ra.",
    "modal.categories": "Danh mục ngân sách",
    "modal.noCategoriesFound": "Không tìm thấy danh mục nào.",
    "modal.payees": "Người nhận thanh toán",
    ...
    "modal.addCategory": "Thêm danh mục",
    "modal.split": "Phân nhỏ (nhiều danh mục)",
    "modal.accounts": "Tài khoản",
    "modal.paymentOrTransfer": "Payment or Transfer",
    "modal.budgetAccounts": "Budget Accounts",
    "modal.trackingAccounts": "Tracking Accounts",
    "modal.noAccountsFound": "Không tìm thấy tài khoản.",
    "modal.deleteAccount": "Xoá tài khoản",
    "modal.delete": "Xóa",
    "modal.closeAccount": "Đóng tài khoản",
    "modal.reopenAccount": "Mở lại",
    "modal.budgetSettings": "Thiết lập ngân sách",
    "modal.newBudget": "New Budget",
    "modal.creatingBudget": "Đang tạo ngân sách...",
    "modal.openBudget": "Open Budget",
    "modal.managePayees": "Quản Lý Người Thụ Hưởng",
    "modal.manageConnections": "Manage Connections",
    "modal.saveACopy": "Lưu một bản sao",
    "modal.makeAFreshStart": "Làm một khởi Đầu mới",
    ...
    "modal.makeAFreshStartDisclaimer": "Bản sao của ngân sách này sẽ được lưu trong trường hợp bạn không hài lòng với những thay đổi. Đừng sợ!",
    "modal.startingFresh": "Bắt Đầu Tươi...",
    "modal.exportBudget": "Export Budget",
    "modal.exportMessage": "Dữ liệu của bạn chỉ là, bạn! Tất cả các dữ liệu ngân sách và dữ liệu giao dịch sẽ được xuất như bài đánh giá, do đó bạn có thể mở chúng một cách dễ dàng.",
    ...
    "modal.createBudgetBtn": "Tạo ngân sách",
    "modal.createAccountBtn": "Thêm tài khoản",
    "modal.saveBudgetSettingsBtn": "Áp dụng các thiết lập",
    "modal.filterTransactions": "Lọc các giao dịch",
    "modal.coverThisOverSpendingWith": "Bìa này bội chi với",
    "modal.coverThisOverBudgetingWith": "Che phủ quá mức này bằng",
    ...
    "modal.approveTransaction": "Chấp nhận giao dịch",
    "modal.rejectTransaction": "Từ chối giao dịch",
    ...
    "modal.disconnected.message": "Bạn đang hoặc ẩn, hay máy chủ của chúng tôi không trả lời. Chúng tôi sẽ cố kết nối lại tự động trong một vài giây.",
    "modal.disconnected.retryBtn": "Bây Giờ Thử Lại",
    "modal.disconnected.reconnectingBtn": "Đang kết nối lại...",
    "modal.matchedTransaction.title": "Xuất Hiện Giao Dịch",
    "modal.matchedTransaction.date": "Ngày",
    "modal.matchedTransaction.payee": "Người nhận thanh toán",
    "modal.matchedTransaction.memo": "Ghi chú",
    "modal.matchedTransaction.approveBtn": "Chấp nhận giao dịch",
    "modal.matchedTransaction.rejectBtn": "Từ chối giao dịch",
    "modal.matchedTransaction.unMatchBtn": "Không khớp Bằng Giao Dịch",
    "modal.matchedTransaction.unMatchBtnTitle": "Không sánh kịp sẽ tạo ra hai tách các giao dịch cho dẫn nhập và nhập khẩu, xuất nhập cảnh.",
    "modal.hiddenCategories.clickACategoryToShowIt": "Nhấn để hiện một mục",
    "modal.hiddenCategories.showAllHiddenCategories": "Hiển thị tất cả các danh mục ẩn",
    "modal.hiddenCategories.noHiddenCategories": "Không có danh mục ẩn",
    ...
    "modal.addAccount.budget": "Ngân sách",
    "modal.addAccount.tracking": "Theo dõi",
    "modal.addAccount.newAccount": "Tài khoản mới",
    "modal.addAccount.editAccount": "Xác nhận {{account}}",
    "modal.addAccount.somethingWrong": "Có lỗi xảy ra.",
    ...
    "reconcile.thisAccountInYNABHasMore": "Số dư đã thanh toán của tài khoản này trong YNAB là<strong>{{difference}}</strong>cao hơn tài khoản thực của bạn.",
    "reconcile.thisAccountInYNABHasLess": "Sự cân bằng xóa tài khoản này trong YNAB là<strong>{{difference}}</strong>thấp hơn của bạn tài khoản thực tế.",
    "reconcile.thisAccountHasTheSame": "Sự cân bằng xóa tài khoản này trong YNAB có sự cân bằng cùng một tài khoản thực tế của bạn.",
    "reconcile.createAdjustmentAndFinish": "Tạo điều chỉnh &amp; Kết thúc",
    "reconcile.finishReconciliation": "Kết thúc hòa giải",
    ...
    "accountSettings.balanceAdjustmentInfo": "Một điều chỉnh giao dịch sẽ được tạo tự động nếu bạn thay đổi số tiền này.",
    "accountSettings.balanceAdjustmentNotice": "Giao dịch điều chỉnh của {{adjustment}} sẽ được tạo tự động cho bạn.",
    "accountSettings.balanceAdjustmentNegativeAsset": "Bạn đã nhập một giá trị tiêu cực đối với một loại tài khoản thường có một sự cân bằng tích cực. Đây có phải là đúng?",
    "accountSettings.balancePlaceholderText": "Sự cân bằng của tài khoản này bây giờ là gì?",
    "accountTypes.Checking": "Tiền gửi",
    "accountTypes.Savings": "Tiết kiệm",
    "accountTypes.Cash": "Tiền mặt",
    "accountTypes.CreditCard": "Thẻ tín dụng",
    "accountTypes.LineOfCredit": "Hạn mức tín dụng",
    "accountTypes.OtherAsset": "Asset (e.g. Investment)",
    "accountTypes.OtherLiability": "Liability (e.g. Mortgage)",
    "closeAccount.positiveBalanceMessage": "Trước khi bạn có thể đóng tài khoản này, bạn cần chuyển {{balance}} còn lại sang một tài khoản khác. Chọn tài khoản mà bạn muốn chuyển số dư dưới đây.",
    "closeAccount.negativeBalanceMessage": "Đàng trước bạn có thể đóng tài khoản này, bạn cần chuyển {{balance}} bạn nợ từ một tài khoản khác. Chọn tài khoản mà bạn muốn chuyển số dư từ bên dưới.",
    ...
    "closeAccount.adjustBalanceBtn": "Điều chỉnh số dư",
    "closeAccount.transferFundsBtn": "Transfer Funds",
    "closeAccount.finishClosingBtn": "Hoàn tất việc đóng tài khoản",
    "closeAccount.to": "Đến:",
    "closeAccount.from": "Từ:",
    ...
    "closeAccount.transferMemo": "Đang đóng tài khoản.",
    "budgetSettings.budgetNameLabel": "Tên ngân sách:",
    "budgetSettings.currencyLabel": "Tiền tệ:",
    "budgetSettings.currencyFormatLabel": "Định dạng số:",
    "budgetSettings.currencySymbolPlacementLabel": "Vị trí ký hiệu tiền tệ:",
    ...
    "budgetSettings.dateFormatLabel": "Định dạng ngày:",
    ...
    "sidebar.accounts": "Tất cả tài khoản",
    "sidebar.onBudget": "NGÂN SÁCH",
    "sidebar.offBudget": "TRACKING",
    "sidebar.closed": "ĐÃ ĐÓNG",
    "sidebar.addAccount": "Thêm tài khoản",
    ...
    "budget.leftToBudget": "Chờ lập ngân sách",
    "budget.ageOfMoney": "Age of Money",
    "budget.ageOfMoneyDays.one": "ngày",
    "budget.ageOfMoneyDays.other": "ngày",
    ...
    "budget.newCategory": "Danh mục mới",
    "budget.newCategoryGroup": "Nhóm danh mục mới",
    ...
    "inspector.totalIncome": "TỔNG THU",
    ...
    "inspector.nothingToPay": "Không có gì để thanh toán.",
    "inspector.ccDebtFree": "Cảm giác không còn nợ nần thật tuyệt.",
    ...
    "inspector.goals.debtFree": "Cảm giác không còn nợ nần thật tuyệt!",
    ...
    "accounts.allAccounts": "Tất cả tài khoản",
    ...
    "accounts.date": "NGÀY",
    "accounts.payee": "NGƯỜI NHẬN THANH TOÁN",
    "accounts.category": "DANH MỤC",
    "accounts.memo": "GHI CHÚ",
    "accounts.outflow": "CHI",
    "accounts.inflow": "THU",
    "accounts.markAsCleared": "Mark as Cleared",
    "accounts.markAsUncleared": "Mark as Uncleared",
    "accounts.approve": "Chấp nhận",
    "accounts.categorizeAs": "Categorize",
    "accounts.reject": "Từ chối",
    ...
    "accounts.latest3months": "3 tháng gần nhất",
    "accounts.thisyear": "Năm nay",
    "accounts.lastyear": "Năm trước",
    ...
    "accounts.needsACategory": "Bạn cần phân loại vào một danh mục",
    ...
    "accounts.inflowPlaceholder": "thu",
    "accounts.outflowPlaceholder": "chi",
    ...
    "accounts.frequency.Never": "Không bao giờ",
    "accounts.frequency.Daily": "Hàng ngày",
    "accounts.frequency.Weekly": "Hàng tuần",
    "accounts.frequency.EveryOtherWeek": "Every other week",
    "accounts.frequency.TwiceAMonth": "Hai lần một tháng",
    "accounts.frequency.Every4Weeks": "Mỗi 4 tuần",
    "accounts.frequency.Monthly": "Hàng tháng",
    "accounts.frequency.EveryOtherMonth": "Every other month",
    "accounts.frequency.Every3Months": "Mỗi 3 tháng",
    "accounts.frequency.Every4Months": "Mỗi 4 tháng",
    "accounts.frequency.TwiceAYear": "Hai lần một năm",
    "accounts.frequency.Yearly": "Hàng năm",
