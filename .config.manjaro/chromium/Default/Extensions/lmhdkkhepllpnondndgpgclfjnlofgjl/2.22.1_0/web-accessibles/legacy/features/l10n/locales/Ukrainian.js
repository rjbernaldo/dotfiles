(function (global, factory) {
  ...
  ynabToolKit.l10nData = {
    ...
    "app.reset": "Reset",
    "app.back": "Повернутися",
    "app.edit": "Редагувати",
    "app.saveAndAddAnother": "Зберегти і додати ще",
    "app.saveCopy": "Зберегти копію",
    "app.didYouMean": "Ви мали на увазі {{word}}?",
    "app.from": "Від",
    "app.to": "До",
    "app.move": "Перенести",
    "app.show": "Показати",
    ...
    "loading.loading": "Завантаження {{{item}}}",
    ...
    "modal.deleteAccount": "Видалити обліковий запис",
    "modal.delete": "Видалити",
    "modal.closeAccount": "Закрити обліковий запис",
    "modal.reopenAccount": "Re-open",
    "modal.budgetSettings": "Налаштування бюджету",
    "modal.newBudget": "New Budget",
    "modal.creatingBudget": "Створення бюджету...",
    "modal.openBudget": "Open Budget",
    "modal.managePayees": "Manage Payees",
    "modal.manageConnections": "Manage Connections",
    "modal.saveACopy": "Зберегти копію",
    ...
    "modal.makeAFreshStartDisclaimer": "Копію цього бюджету буде збережено у випадку, якщо ви не задоволені змінами. Не бійтеся!",
    "modal.startingFresh": "Починаємо все спочатку...",
    "modal.exportBudget": "Export Budget",
    "modal.exportMessage": "Ваші дані - так, ваші! Всі дані вашого бюджету будуть збережені у CSV файлі, який можна легко відкрити у інших програмах.",
    ...
    "modal.createBudgetBtn": "Створити бюджет",
    "modal.createAccountBtn": "Додати рахунок",
    "modal.saveBudgetSettingsBtn": "Застосувати параметри",
    "modal.filterTransactions": "Фільтрувати транзакції",
    "modal.coverThisOverSpendingWith": "Покрити перевитрати з",
    "modal.coverThisOverBudgetingWith": "Покрити дефіцит бюджету з",
    ...
    "modal.approveTransaction": "Підтвердити транзакцію",
    "modal.rejectTransaction": "Відхилити транзакцію",
    ...
    "modal.disconnected.header": "Ой-ой!",
    "modal.disconnected.message": "Ви або офлайн, або наш сервер не відповідає. Ми спробуємо відновити зв'язок автоматично за декілька секунд.",
    "modal.disconnected.retryBtn": "Спробувати знову",
    "modal.disconnected.reconnectingBtn": "Відновлення зв'язку...",
    "modal.matchedTransaction.title": "Транзакція співпадає",
    "modal.matchedTransaction.date": "Дата",
    "modal.matchedTransaction.payee": "Контрагент",
    "modal.matchedTransaction.memo": "Примітка",
    "modal.matchedTransaction.approveBtn": "Підтвердити транзакцію",
    "modal.matchedTransaction.rejectBtn": "Відхилити транзакцію",
    "modal.matchedTransaction.unMatchBtn": "Транзакція не співпадає",
    "modal.matchedTransaction.unMatchBtnTitle": "Якщо транзакції не співпадають, буду створено дві окремі транзакції - створена вручну і імпортована.",
    "modal.hiddenCategories.clickACategoryToShowIt": "Відкрити категорію",
    "modal.hiddenCategories.showAllHiddenCategories": "Показати всі приховані категорії",
    "modal.hiddenCategories.noHiddenCategories": "Немає схованих категорій",
    ...
    "modal.addAccount.budget": "Бюджет",
    "modal.addAccount.tracking": "Відстеження (поза бюджетом)",
    ...
    "accountTypes.Checking": "Перевірка",
    "accountTypes.Savings": "Savings",
    "accountTypes.Cash": "Готівка",
    "accountTypes.CreditCard": "Кредитна карта",
    ...
    "closeAccount.to": "Кому:",
    "closeAccount.from": "Звідки:",
    ...
    "budgetSettings.currencyFormatLabel": "Формат цифр:",
    ...
    "budget.ageOfMoneyDays.one": "день",
    ...
    "accounts.frequency.Never": "Ніколи",
