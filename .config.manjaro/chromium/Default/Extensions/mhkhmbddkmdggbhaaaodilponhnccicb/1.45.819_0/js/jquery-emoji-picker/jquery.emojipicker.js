; (function ($) {
    ...
    $.extend(EmojiPicker.prototype, {
        ...
        emojiCategoryClicked: function (e) {
            ...
            if ($(e.target).parent().parent().hasClass('tab') || $(e.target).parent().hasClass('tab')) {
                section = $(e.target).closest('.tab').attr('data-tab');
    ...
    function getPickerHTML() {
        ...
        nodes.push('<div style="padding:15px 10px 0 10px "><img src="https://www.tubebuddy.com/images/branding/logo_small.png" style="width: 100px;"></div>');

        // Recent Tab, if localstorage support
        if (localStorageSupport) {
            nodes.push('<div class="tab active" data-tab="recent"><div class="emoji emoji-tab-recent"><i class="material-icons tb-emoji-category-icon">access_time</i></div></div>');
        }
        ...
        for (var i = 0; i < categories_length; i++) {
            nodes.push('<div class="tab' +
                ...
                categories[i].name +
                '"><i class="material-icons tb-emoji-category-icon">' + categories[i].maticon + '</i></div></div>');
        }
        nodes.push('</nav>');
    ...
    function insertAtCaret(inputField, myValue) {
           ...
           TBUtilities.Log('String: ' + jQuery(inputField).is('yt-formatted-string'));
        ...
        if (document.selection) {
            ...
            if (jQuery(inputField).is('div') || jQuery(inputField).is('yt-formatted-string')) {
                inputField.innerHTML = myValue;
            } else {
            ...
            if (jQuery(inputField).is('div') || jQuery(inputField).is('yt-formatted-string')) {
                inputField.innerHTML = inputField.innerHTML.substring(0, startPos) + myValue + inputField.innerHTML.substring(endPos, inputField.innerHTML.length);
            } else {
            ...
            // Not selected at all, add to end
            inputField.focus();
