(function (global, factory) {
  ...
  ynabToolKit.l10nData = {
    ...
    "app.makeRecurring": "Ismétlődővé tesz",
    "app.export": "Exportálás",
    "app.retry": "Retry",
    "app.youNeedABudget": "You Need a Budget",
    "aria.checkName": "Csekk: {{name}}",
    "aria.checkAllCategories": "Az összes kategória kiválasztása",
    "aria.checkAllTransactions": "Az összes tranzakció kiválasztása",
    "aria.checkAllPayees": "Az összes partner kiválasztása",
    ...
    "modal.directImportStatus.troubleshoot": "Hibaelhárítás",
    "modal.directImportStatus.lastUpdated": "utóljára frissítve: {{timeAgo}}",
    ...
    "inspector.youAreShortOfYourGoalForTheMonth": "Már csak <strong>{{toGo}}</strong> összegre vagy a havi célodtól. Ossz be még ide <strong>{{toGo}}</strong> összeget, hogy sínen maradj a célod felé.",
    ...
    "accounts.linkedWith": "Összerendelve a {{account}} számlával a {{institution}} pénzintézetnél",
    ...
    "fileImport.includeTransactionsDatedBeforeStartDate.one": "1 régebbi tranzakciót tartalmaz mint a számla létrehozása",
    "fileImport.includeTransactionsDatedBeforeStartDate.other": "{{amount}} régebbi tranzakciót tartalmaz mint a számla létrehozása",
    ...
    "accountWidget.chooseYourAccountTypeAndSetANickname": "Válaszd ki a számla típusát, és adjon neki egy nevet.",
    ...
    "accountWidget.fileImportNote": "Fájlok importálása",
    "accountWidget.fileImportNoteDetails": "Ahhoz, hogy összerendelés nélkül importálni tudj adatokat a pénzintézettől, töltsd le a tranzakcióidat a weboldalukról.",
    "accountWidget.fileImportNoteFormats": "Formátumok: OFX, QFX, QIF, CSV",
    ...
    "accountWidget.usAndCanadaOnly": "Csak az Egyesült Államokban és Kanadában elérhető.",
    ...
    "accountWidget.wasThisHelpful": "Hasznos volt?",
