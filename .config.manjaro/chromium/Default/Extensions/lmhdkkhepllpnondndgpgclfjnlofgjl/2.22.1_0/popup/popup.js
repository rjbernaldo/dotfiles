...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(109);

var popup = new _popup__WEBPACK_IMPORTED_MODULE_0__["Popup"]();
popup.initListeners();
...
/* harmony import */ var core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(71);
/* harmony import */ var core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74);
...
/* harmony import */ var core_js_modules_es6_object_to_string__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(49);
/* harmony import */ var core_js_modules_es6_object_to_string__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_object_to_string__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var toolkit_core_common_storage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(63);
/* harmony import */ var toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(61);
...
class Popup {
  constructor() {
    _defineProperty(this, "_storage", new toolkit_core_common_storage__WEBPACK_IMPORTED_MODULE_4__["ToolkitStorage"]());

    _defineProperty(this, "_browser", Object(toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_5__["getBrowser"])());

    _defineProperty(this, "_applyDarkMode", isDarkMode => {
      if (isDarkMode) {
    ...
    _defineProperty(this, "_openOptionsPage", () => {
      if (Object(toolkit_core_common_web_extensions__WEBPACK_IMPORTED_MODULE_5__["getBrowserName"])() === 'edge') {
    ...
    _defineProperty(this, "_toggleToolkitDisabledUI", isToolkitDisabled => {
      var logoPath = `assets/images/logos/toolkitforynab-logo-200${isToolkitDisabled ? '-disabled' : ''}.png`;

      var logoURL = this._browser.runtime.getURL(logoPath);

      $('#logo').attr('src', logoURL);
      $('#toggleToolkit > i').addClass(isToolkitDisabled ? 'fa-toggle-off' : 'fa-toggle-on').removeClass(isToolkitDisabled ? 'fa-toggle-on' : 'fa-toggle-off');
    });

    _defineProperty(this, "_toggleToolkitDisabledSetting", () => {
    ...
    var manifest = this._browser.runtime.getManifest();

    $('#versionNumber').text(manifest.version);
    $('.toolkit-name').text(manifest.name);
    Promise.all([this._storage.getStorageItem('options.dark-mode', {
      default: false
    }), this._storage.getFeatureSetting(TOOLKIT_DISABLED_FEATURE_SETTING, {
      default: false
    })]).then((_ref) => {
