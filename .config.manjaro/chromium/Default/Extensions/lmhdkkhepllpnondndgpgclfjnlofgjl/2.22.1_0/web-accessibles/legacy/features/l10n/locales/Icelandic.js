(function (global, factory) {
  ...
  ynabToolKit.l10nData = {
    ...
    "app.continue": "Áfram",
    "app.ok": "OK",
    "app.okay": "Allt í lagi",
    "app.save": "Vista",
    "app.send": "Senda",
    "app.delete": "Eyða",
    "app.deleting": "Deleting...",
    "app.cancel": "Hætta við",
    "app.reset": "Reset",
    "app.back": "Til baka",
    "app.edit": "Breyta",
    "app.saveAndAddAnother": "Vista og bæta við",
    "app.saveCopy": "Vista eintak",
    "app.didYouMean": "Meintiru {{word}}?",
    "app.from": "Frá",
    "app.to": "Til",
    "app.move": "Flytja",
    "app.show": "Sýna",
    ...
    "app.no": "Nei",
    "app.close": "Loka",
    "app.account": "Reikningur",
    "app.date": "Dagsetning",
    "app.payee": "Greiðsluþegi",
    "app.memo": "Minnismiði",
    "app.amount": "Upphæð",
    "app.next": "Næsta",
    "app.complete": "Búið",
    ...
    "error.unknown": "Óþekkt villa hefur komið upp.",
    "modal.categories": "Áætlunarflokkar",
    "modal.noCategoriesFound": "Engir flokkar fundust.",
    "modal.payees": "Greiðsluþegar",
    ...
    "modal.addCategory": "Bæta við flokk",
    "modal.split": "Skipta (í marga flokka)",
    "modal.accounts": "Reikningar",
    "modal.paymentOrTransfer": "Payment or Transfer",
    "modal.budgetAccounts": "Budget Accounts",
    "modal.trackingAccounts": "Tracking Accounts",
    "modal.noAccountsFound": "Engir reikningar fundust.",
    "modal.deleteAccount": "Eyða reikningi",
    "modal.delete": "Eyða",
    "modal.closeAccount": "Loka reikningi",
    "modal.reopenAccount": "Enduropna",
    "modal.budgetSettings": "Áætlunarstillingar",
    "modal.newBudget": "New Budget",
    "modal.creatingBudget": "Bý til áætlun...",
    "modal.openBudget": "Open Budget",
    "modal.managePayees": "Manage Payees",
    "modal.manageConnections": "Manage Connections",
    "modal.saveACopy": "Vista eintak",
    ...
    "modal.startingFresh": "Byrjandi aftur frá grunni...",
    ...
    "modal.createBudgetBtn": "Búa til áætlun",
    "modal.createAccountBtn": "Bæta við reikning",
    "modal.saveBudgetSettingsBtn": "Stilla stillingar",
    "modal.filterTransactions": "Sía færslur",
    ...
    "modal.approveTransaction": "Samþykkja færslu",
    "modal.rejectTransaction": "Hafna færslu",
    ...
    "modal.disconnected.retryBtn": "Reyna aftur núna",
    "modal.disconnected.reconnectingBtn": "Tengist aftur...",
    "modal.matchedTransaction.title": "Matched Transaction",
    "modal.matchedTransaction.date": "Dagsetning",
    "modal.matchedTransaction.payee": "Greiðsluþegi",
    "modal.matchedTransaction.memo": "Minnismiði",
    "modal.matchedTransaction.approveBtn": "Samþykkja færslu",
    "modal.matchedTransaction.rejectBtn": "Hafna færslu",
    "modal.matchedTransaction.unMatchBtn": "Færsla á ekki við",
    ...
    "modal.hiddenCategories.clickACategoryToShowIt": "Ýttu til að sýna flokkinn aftur",
    "modal.hiddenCategories.showAllHiddenCategories": "Sýna alla falda flokka",
    "modal.hiddenCategories.noHiddenCategories": "Engir faldir flokkar",
    ...
    "modal.addAccount.budget": "Áætlun",
    "modal.addAccount.tracking": "Tracking",
    "modal.addAccount.newAccount": "Nýr reikningur",
    "modal.addAccount.editAccount": "Authenticate {{account}}",
    "modal.addAccount.somethingWrong": "Eitthvað klikkaði.",
    ...
    "modal.reconcile.thereIsADifference": "Það er munur upp á {{difference}}.",
    ...
    "closeAccount.transferFunds": "Flytja innistæðu:",
    "closeAccount.adjustBalanceBtn": "Breyta innistæðu",
    "closeAccount.transferFundsBtn": "Flytja innistæðu",
    "closeAccount.finishClosingBtn": "Klára að loka reikning",
    "closeAccount.to": "Til:",
    "closeAccount.from": "Frá:",
    ...
    "closeAccount.transferMemo": "Loka reikning.",
    "budgetSettings.budgetNameLabel": "Nafn áætlunar:",
    "budgetSettings.currencyLabel": "Gjaldmiðill:",
    "budgetSettings.currencyFormatLabel": "Talnagerð:",
    "budgetSettings.currencySymbolPlacementLabel": "Staðsetning gjaldmiðilsmerkis:",
    "budgetSettings.currencySymbolPlacementBeforeLabel": "Á undan upphæð",
    "budgetSettings.currencySymbolPlacementAfterLabel": "Á eftir upphæð",
    "budgetSettings.currencySymbolPlacementNoneLabel": "Ekki sýna merki",
    "budgetSettings.dateFormatLabel": "Gerð dagsetningar:",
    "budgetCategory.enterCategoryName": "Skráðu inn nafn á flokk",
    ...
    "sidebar.budget": "Áætlun",
    "sidebar.reports": "Skýrslur",
    "sidebar.accounts": "Allir reikningar",
    "sidebar.onBudget": "ÁÆTLUN",
    "sidebar.offBudget": "TRACKING",
    "sidebar.closed": "LOKAÐ",
    "sidebar.addAccount": "Bæta við reikning",
    ...
    "onboarding3.categoryAvailable": "Flokkar í boði",
    ...
    "budget.leftToBudget": "Það sem á eftir að áætla",
    "budget.ageOfMoney": "Aldur penings",
    "budget.ageOfMoneyDays.one": "dagur",
    "budget.ageOfMoneyDays.other": "dagar",
    "budget.ageOfMoneyNotAvailable": "???",
    "budget.categoryGroup": "Hópur flokks",
    "budget.addCategoryGroup": "Bæta við flokkahóp",
    "budget.quickBudget": "Quick Budget",
    "budget.debtSnowball": "Debt Snowball",
    "budget.category": "FLOKKUR",
    "budget.budgeted": "ÁÆTLAÐ",
    "budget.activity": "BREYTINGAR",
    "budget.available": "NOTHÆFT",
    "budget.cc.category": "CREDIT CARD PAYMENTS",
    "budget.cc.budgeted": "BUDGETED",
    "budget.cc.activity": "ACTIVITY",
    "budget.cc.payment": "PAYMENT",
    "budget.uncategorizedTransactions": "Óflokkaðar færslur",
    "budget.hiddenCategories": "Faldir flokkar",
    ...
    "budget.newCategory": "Nýr flokkur",
    "budget.newCategoryGroup": "Nýr flokkahópur",
    ...
    "accounts.thisyear": "Þetta ár",
    "accounts.lastyear": "Síðasta ár",
    ...
    "accounts.needsACategory": "Þetta þarfnast flokkunar",
    ...
    "accounts.frequency.Never": "Aldrei",
    "accounts.frequency.Daily": "Daglega",
    "accounts.frequency.Weekly": "Vikulega",
    "accounts.frequency.EveryOtherWeek": "Aðrahvora viku",
    "accounts.frequency.TwiceAMonth": "Tvisvar í mánuði",
    "accounts.frequency.Every4Weeks": "Hverja 4 viku",
    "accounts.frequency.Monthly": "Mánaðarlega",
    ...
    "accounts.frequency.TwiceAYear": "Tvisvar á ári",
    "accounts.frequency.Yearly": "Árlega",
    "accounts.frequency.EveryOtherYear": "Annað hvert ár",
    ...
    "search.needsCategory": "Þarfnast flokks",
