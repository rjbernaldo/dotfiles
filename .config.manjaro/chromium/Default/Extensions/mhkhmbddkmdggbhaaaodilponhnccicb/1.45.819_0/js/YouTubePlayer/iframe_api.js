(function () {
    var g, k = this; function l(a) { a = a.split("."); for (var b = k, c; c = a.shift() ;) if (null != b[c]) b = b[c]; else return null; return b }
    function aa() { }
    ...
    ; var oa = Array.prototype.indexOf ? function (a, b, c) { return Array.prototype.indexOf.call(a, b, c) } : function (a, b, c) {
        c = null == c ? 0 : 0 > c ? Math.max(0, a.length + c) : c;
        if (r(a)) return r(b) && 1 == b.length ? a.indexOf(b, c) : -1; for (; c < a.length; c++) if (c in a && a[c] === b) return c; return -1
    }, y = Array.prototype.forEach ? function (a, b, c) { Array.prototype.forEach.call(a, b, c) } : function (a, b, c) { for (var d = a.length, e = r(a) ? a.split("") : a, f = 0; f < d; f++) f in e && b.call(c, e[f], f, a) };
    ...
    var Aa; a: {
        var Ba = "", Ca = function () { var a = B; if (E) return /rv\:([^\);]+)(\)|;)/.exec(a); if (xa) return /Edge\/([\d\.]+)/.exec(a); if (D) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a); if (ya) return /WebKit\/(\S+)/.exec(a); if (wa) return /(?:Version)[ \/]?(\S+)/.exec(a) }();
        Ca && (Ba = Ca ? Ca[1] : ""); if (D) { var Da = za(); if (null != Da && Da > parseFloat(Ba)) { Aa = String(Da); break a } } Aa = Ba
    } var Ea = Aa, va = {};
    ...
    var Pa;
    function Qa() {
        var a = k.MessageChannel; "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !C("Presto") && (a = function () {
        ...
        if ("undefined" !== typeof a && !C("Trident") && !C("MSIE")) {
            var b = new a, c = {}, d = c; b.port1.onmessage = function () { if (void 0 !== c.next) { c = c.next; var a = c.G; c.G = null; a() } };
            return function (a) { d.next = { G: a }; d = d.next; b.port2.postMessage(0) }
    ...
    var F; function Wa() {
        var a = k.Promise; if (-1 != String(a).indexOf("[native code]")) { var b = a.resolve(void 0); F = function () { b.then(Za) } } else F = function () {
            var a = Za;
    ...
    ; var kb = l("yt.dom.getNextId_"); if (!kb) {
        kb = function () { return ++lb };
        v("yt.dom.getNextId_", kb); var lb = 0
    }; function K(a) {
        this.type = ""; this.source = this.data = this.currentTarget = this.relatedTarget = this.target = null; this.charCode = this.keyCode = 0; this.shiftKey = this.ctrlKey = this.altKey = !1; this.clientY = this.clientX = 0; if (a = a || window.event) {
            this.a = a; for (var b in a) b in mb || (this[b] = a[b]); (b = a.target || a.srcElement) && 3 == b.nodeType && (b = b.parentNode); this.target = b; if (b = a.relatedTarget) try { b = b.nodeName ? b : null } catch (c) { b = null } else "mouseover" == this.type ? b = a.fromElement : "mouseout" == this.type && (b = a.toElement); this.relatedTarget =
    ...
    function pb(a, b, c) {
        if (a && (a.addEventListener || a.attachEvent)) {
            var d = ob(a, b, c); if (!d) {
                var d = ++nb.count + "", e = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document), f; f = e ? function (d) { d = new K(d); if (!La(d.relatedTarget, function (b) { return b == a })) return d.currentTarget = a, d.type = b, c.call(a, d) } : function (b) {
                    b = new K(b);
    ...
    function Db(a) {
        if (a instanceof S) return a; if ("function" == typeof a.m) return a.m(!1); if (q(a)) {
            var b = 0, c = new S; c.next = function () { for (; ;) { if (b >= a.length) throw R; if (b in a) return a[b++]; b++ } };
            return c
    ...
    function Fb(a) {
        if (q(a)) return z(a); a = Db(a); var b = []; Eb(a, function (a) { b.push(a) });
        return b
    }
    ; function T() { }
    ...
    g.m = function (a) {
        var b = 0, c = this.a, d = new S; d.next = function () { if (b >= c.length) throw R; var d = c.key(b++); if (a) return d; d = c.getItem(d); if (!r(d)) throw "Storage mechanism: Invalid value was encountered"; return d };
        return d
    };
    ...
    function Ob(a, b) {
        y(b, function (a) {
            this[a] || ("getCurrentTime" == a ? this[a] = function () { var a = this.j.currentTime; if (1 == this.j.playerState) { var b = (fa() / 1E3 - this.j.currentTimeLastUpdated_) * this.j.playbackRate; 0 < b && (a += Math.min(b, 1)) } return a } : Jb(a) ? this[a] = function () {
                this.j = {};
                this.i = {}; Q(this, a, arguments); return this
            } : Kb(a) ? this[a] = function () {
                var b = 0;
