(function (global, factory) {
  ...
  ynabToolKit.l10nData = {
    ...
    "app.back": "Indietro",
    "app.edit": "Modifica",
    "app.saveAndAddAnother": "Salva e aggiungi un altro",
    "app.saveCopy": "Salva una copia",
    "app.didYouMean": "Volevi dire {{word}}?",
    "app.from": "Da",
    "app.to": "A",
    "app.move": "Sposta",
    "app.show": "Mostra",
    ...
    "app.refresh": "Refresh",
    "app.skip": "Salta",
    "app.saveAndNext": "Salva e Successivo",
    "app.undo": "Undo",
    "app.redo": "Redo",
    "app.remove": "Remove",
    ...
    "loading.loading": "Caricando {{{item}}}",
    ...
    "modal.categories": "Categorie del Budget",
    "modal.noCategoriesFound": "Nessuna categoria trovata.",
    "modal.payees": "Beneficiari",
    ...
    "modal.addCategory": "Aggiungi una categoria",
    "modal.split": "Dividi (più categorie)",
    "modal.accounts": "Conti",
    "modal.paymentOrTransfer": "Payment or Transfer",
    "modal.budgetAccounts": "Budget Accounts",
    "modal.trackingAccounts": "Tracking Accounts",
    "modal.noAccountsFound": "Nessun conto trovato.",
    "modal.deleteAccount": "Elimina conto",
    "modal.delete": "Cancella",
    "modal.closeAccount": "Chiudi il conto",
    "modal.reopenAccount": "Riapri",
    "modal.budgetSettings": "Impostazioni di bilancio",
    "modal.newBudget": "New Budget",
    "modal.creatingBudget": "Creando un bilancio...",
    "modal.openBudget": "Open Budget",
    "modal.managePayees": "Manage Payees",
    "modal.manageConnections": "Manage Connections",
    "modal.saveACopy": "Salva una copia",
    ...
    "modal.makeAFreshStartDisclaimer": "Una copia di questo bilancio verrà salvata nel caso non dovessi essere soddisfatto delle modifiche. Non temere!",
    "modal.startingFresh": "Un nuovo inizio...",
    "modal.exportBudget": "Export Budget",
    "modal.exportMessage": "I tuoi dati sono tuoi! Tutti i vostri dati del budget e di ogni transazione saranno esportati come file CSV cosi da poter essere aperti facilmente in altre applicazioni.",
    ...
    "modal.myAccount": "Il mio Account",
    "modal.logOut": "Log Out",
    "modal.createBudgetBtn": "Crea un bilancio",
    "modal.createAccountBtn": "Aggiungi un conto",
    "modal.saveBudgetSettingsBtn": "Applica le impostazioni",
    "modal.filterTransactions": "Filtra le transazioni",
    "modal.coverThisOverSpendingWith": "Coprire questa spesa eccessiva con",
    "modal.coverThisOverBudgetingWith": "Coprire questa sopravvalutazione con",
    ...
    "modal.approveTransaction": "Approva la transazione",
    "modal.rejectTransaction": "Rifiuta la transazione",
    ...
    "modal.subscribeNow": "Abbonati ora.",
    ...
    "modal.disconnected.message": "O non sei in linea, o il nostro server non risponde. Cercheremo di riconnetterti automaticamente tra pochi secondi.",
    "modal.disconnected.retryBtn": "Riprova adesso",
    "modal.disconnected.reconnectingBtn": "Riconnessione in corso...",
    "modal.matchedTransaction.title": "Transazione Abbinata",
    "modal.matchedTransaction.date": "Data",
    "modal.matchedTransaction.payee": "Beneficiario",
    "modal.matchedTransaction.memo": "Nota",
    "modal.matchedTransaction.approveBtn": "Approva la transazione",
    "modal.matchedTransaction.rejectBtn": "Rifiuta la transazione",
    "modal.matchedTransaction.unMatchBtn": "Disabbina Transazione",
    "modal.matchedTransaction.unMatchBtnTitle": "Disabbinando si creeranno due transazioni separate, una sarà quella manuale e una quella importata.",
    "modal.hiddenCategories.clickACategoryToShowIt": "Fare clic per visualizzare una categoria",
    "modal.hiddenCategories.showAllHiddenCategories": "Mostra tutte le Categorie nascoste",
    "modal.hiddenCategories.noHiddenCategories": "Nessuna categoria nascosta",
    ...
    "modal.debtActivity.totalActivity": "Totale attività",
    ...
    "modal.addAccount.budget": "Bilancio",
    "modal.addAccount.tracking": "Rilevamento",
    "modal.addAccount.newAccount": "Nuovo conto",
    "modal.addAccount.editAccount": "Autenticare {{account}}",
    "modal.addAccount.somethingWrong": "Qualcosa è andato storto.",
    "modal.addAccount.account": "ACCOUNT",
    "modal.addAccount.balance": "BALANCE",
    "modal.reconcile.isYourCurrentAccountBalance": "È il saldo <strong>attuale</strong> del conto",
    "modal.reconcile.howDoIFindMyAccountBalance": "Come trovo il saldo del mio conto?",
    "modal.reconcile.accountReconciled": "Conto riconciliato!",
    "modal.reconcile.reconcilationDance": "Tempo del ballo di riconciliazione.",
    "modal.reconcile.enterYourCurrentBalance": "Inserisci il tuo saldo <strong>attuale</strong>:",
    "modal.reconcile.thereIsADifference": "C'è una differenza di {{difference}}.",
    ...
    "modal.reconcile.skipThisExplanationInTheFuture": "Non mostrare più questa spiegazione",
    ...
    "accountSettings.balanceAdjustmentNegativeAsset": "Hai inserito un valore negativo per un tipo di conto che normalmente ha un saldo positivo. È corretto?",
    "accountSettings.balancePlaceholderText": "What is the balance of this account right now?",
    "accountTypes.Checking": "Conto corrente",
    "accountTypes.Savings": "Risparmi",
    "accountTypes.Cash": "Contanti",
    "accountTypes.CreditCard": "Carta di credito",
    "accountTypes.LineOfCredit": "Fido bancario",
    ...
    "closeAccount.transferFunds": "Trasferisci fondi:",
    "closeAccount.adjustBalanceBtn": "Correggi il saldo",
    "closeAccount.transferFundsBtn": "Trasferisci fondi",
    "closeAccount.finishClosingBtn": "Finish Closing Account",
    "closeAccount.to": "A:",
    "closeAccount.from": "Da:",
    ...
    "closeAccount.transferMemo": "Chiusura conto.",
    "budgetSettings.budgetNameLabel": "Nome del bilancio:",
    "budgetSettings.currencyLabel": "Valuta:",
    "budgetSettings.currencyFormatLabel": "Formato numeri:",
    "budgetSettings.currencySymbolPlacementLabel": "Posizionamento valuta:",
    "budgetSettings.currencySymbolPlacementBeforeLabel": "Prima la cifra",
    "budgetSettings.currencySymbolPlacementAfterLabel": "Dopo la cifra",
    "budgetSettings.currencySymbolPlacementNoneLabel": "Non visualizzare il simbolo",
    "budgetSettings.dateFormatLabel": "Formato data:",
    "budgetCategory.enterCategoryName": "Inserisci nome categoria",
    "budgetCategory.deductFromNextMonth": "Detrai dal mese prossimo",
    "budgetCategory.deductFromCategoryBalance": "Detrai dal saldo di categoria",
    "sidebar.budget": "Bilancio",
    "sidebar.reports": "Resoconti",
    "sidebar.accounts": "Tutti i conti",
    "sidebar.onBudget": "BILANCIO",
    "sidebar.offBudget": "MONITORAGGIO",
    "sidebar.closed": "CHIUSO",
    "sidebar.addAccount": "Aggiungi un conto",
    ...
    "onboarding3.youreReady": "Sei pronto!",
    ...
    "onboarding3.categoryAvailable": "Categoria disponibile",
    ...
    "budget.leftToBudget": "Da mettere a Bilancio",
    "budget.ageOfMoney": "Età del Denaro",
    "budget.ageOfMoneyDays.one": "giorno",
    "budget.ageOfMoneyDays.other": "giorni",
    "budget.ageOfMoneyNotAvailable": "???",
    "budget.categoryGroup": "Gruppo di categorie",
    "budget.addCategoryGroup": "Aggiungi Gruppo Categoria",
    "budget.quickBudget": "Quick Budget",
    "budget.debtSnowball": "Debt Snowball",
    "budget.category": "CATEGORIA",
    "budget.budgeted": "BILANCIO",
    "budget.activity": "ATTIVITÀ",
    "budget.available": "DISPONIBILE",
    "budget.cc.category": "CREDIT CARD PAYMENTS",
    "budget.cc.budgeted": "BUDGETED",
    "budget.cc.activity": "ACTIVITY",
    "budget.cc.payment": "PAYMENT",
    "budget.uncategorizedTransactions": "Transazioni non categorizzate",
    "budget.hiddenCategories": "Categorie nascoste",
    "budget.fundsFor": "Fondi per {{currentMonth}}",
    "budget.incomeFor": "{{currentMonth}} Income",
    "budget.overspentIn": "Budget sforato in {{month}}",
    "budget.fundedIn": "Preventivato in {{currentMonth}}",
    "budget.fundedInFuture": "Budgeted in Future",
    "budget.otherMonthsActivity": "Other Months' Activity",
    "budget.enterANote": "Inserisci una nota...",
    "budget.unhideAll": "Mostra tutto",
    ...
    "budget.newCategory": "Nuova Categoria",
    "budget.newCategoryGroup": "Aggiungi Gruppo Categoria",
    "budget.Uncategorized": "Senza categoria",
    ...
    "inspector.totalIncome": "ENTRATE TOTALI",
    "inspector.totalActivity": "TOTALE ATTIVITÀ",
    "inspector.totalAvailable": "TOTALE DISPONIBILE",
    "inspector.fundCategories": "QUICK BUDGET",
    "inspector.fundSelectedCategories": "QUICK BUDGET SELECTED",
    "inspector.categoriesSelected": "Categorie selezionate",
    "inspector.quickBudget": "Quick Budget",
    "inspector.cashLeftOver": "Contante rimasto da",
    "inspector.budgetedThisMonth": "Finanziato questo mese",
    "inspector.activityThisMonth": "Attività di questo mese",
    "inspector.cashSpending": "Cash Spending",
    "inspector.creditSpending": "Credit Spending",
    "inspector.available": "Disponibile",
    "inspector.payment": "Pagamento",
    "inspector.nothingToPay": "Niente da pagare.",
    "inspector.ccDebtFree": "Essere liberi dai debiti è una cosa bellissima.",
    ...
    "inspector.targetBalance": "Ammontare Obiettivo",
    ...
    "inspector.budgeted": "Messo a Bilancio",
    "inspector.funded": "Funded",
    "inspector.toGo": "Ancora",
    ...
    "inspector.goalMFMessage": "Finanzia ancora {{toGo}} per raggiungere il tuo obiettivo mensile di {{goalTarget}}.",
    "inspector.goalMFSuccessMessage": "Hai raggiunto il tuo obiettivo di {{goalTarget}} per questo mese!",
    ...
    "inspector.goalTBSuccessMessage": "Hai raggiunto il tuo obiettivo di {{goalTarget}} per questo mese!",
    ...
    "inspector.availableMessage.upcomingTitle": "Clicca qui per visualizzare la lista delle transazioni imminenti di questo mese.",
    "inspector.availableMessage.upcoming.one": "1 transazione imminente",
    "inspector.availableMessage.upcoming.other": "{{count}} transazioni immimenti",
    "inspector.availableMessage.afterUpcomingPositiveTitle": "Questo è quanto puoi spendere senza toccare il denaro messo da parte per le transazioni imminenti.",
    "inspector.availableMessage.afterUpcomingNegativeTitle": "Aggiungi denaro per coprire le transazioni imminenti.",
    "inspector.availableMessage.afterUpcoming": "Disponibilità dopo le transazioni imminenti",
    "inspector.notes": "Note",
    "inspector.notesPlaceholder": "Inserisci una nota...",
    ...
    "inspector.combinedOverSpending": "In questa categoria hai sforato il budget di <strong>{{overSpentAmount}}</strong> con contanti e credito. Aggiungi almeno <strong>{{overSpentCashAmount}}</strong> a questa categoria oppure non potrai fidarti del bilancio!",
    ...
    "accounts.allAccounts": "Tutti i conti",
    "accounts.clearedBalance": "Saldo Liquidato",
    "accounts.unclearedBalance": "Saldo da Liquidare",
    "accounts.workingBalance": "Working Balance",
    "accounts.selectedTotal": "Selected Total ({{count}})",
    "accounts.importTransactions": "Importa",
    ...
    "accounts.markAsCleared": "Segna come Liquidato",
    "accounts.markAsUncleared": "Segna come Da Liquidare",
    "accounts.approve": "Approva",
    "accounts.categorizeAs": "Categorize",
    "accounts.reject": "Rifiuta",
    "accounts.enterInAccountNow": "Enter Now",
    "accounts.moveToAccount": "Move to Account",
    "accounts.match": "Abbina",
    "accounts.unmatch": "Disabbina",
    ...
    "accounts.thismonth": "Questo Mese",
    "accounts.latest3months": "Ultimi 3 mesi",
    "accounts.thisyear": "Quest'anno",
    "accounts.lastyear": "Anno scorso",
    "accounts.alldates": "Tutte le date",
    ...
    "accounts.inflowPlaceholder": "entrata",
    "accounts.outflowPlaceholder": "uscita",
    ...
    "accounts.frequency.Never": "Mai",
    "accounts.frequency.Daily": "Giornalmente",
    "accounts.frequency.Weekly": "Settimanalmente",
    "accounts.frequency.EveryOtherWeek": "Ogni 2 settimane",
    "accounts.frequency.TwiceAMonth": "Due volte al mese",
    "accounts.frequency.Every4Weeks": "Ogni 4 settimane",
    "accounts.frequency.Monthly": "Mensilmente",
    "accounts.frequency.EveryOtherMonth": "Ogni 2 mesi",
    "accounts.frequency.Every3Months": "Ogni 3 mesi",
    "accounts.frequency.Every4Months": "Ogni 4 mesi",
    "accounts.frequency.TwiceAYear": "Due volte l'anno",
    "accounts.frequency.Yearly": "Annualmente",
    "accounts.frequency.EveryOtherYear": "Ogni 2 anni",
    ...
    "reports.income": "Entrate",
    "reports.expense": "Uscite",
    "reports.uncategorizedTransactions": "Transazioni non categorizzate",
    "reports.trackingTransactions": "Tracking Account Transactions",
    "reports.hiddenCategories": "Categorie nascoste",
    "reports.assets": "Assets",
    "reports.debts": "Debiti",
    ...
    "welcome.letsGetStarted": "Iniziamo!",
    ...
    "fileImport.isCorrect": "{{date}} corretta",
    ...
    "tooltip.budget.activityCell": "({{amount}}) Mostra l'attività mensile di questa categoria. Magnifico.",
    ...
    "tooltip.budget.toBudget.overspent": "Totale spesa eccessiva di categoria da {{month}}",
    ...
    "tooltip.accounts.cleared": "La banca conoscre questa transazione, quindi viene liquidata. La banca sa anche altre cose.",
    "tooltip.accounts.uncleared": "Contrassegna allegramente questa transazione come liquidata.",
    ...
    "tooltip.accounts.clearedColumn": "Contrassegnare una transazione come \"Liquidata\" significa che è presente nel conto bancario.",
    ...
    "tooltip.undo": "Annulla l'ultima cosa che hai fatto (in YNAB, non nella vita).",
    "tooltip.redo": "Ripristina ciò che hai appena annullato. Esercita risolutezza.",
