...
* 
* nstructor
* ram {string} offset - for example '-11:00'
*aram {string} olson_tz - the olson Identifier, such as "America/Denver"
* ram {boolean} uses_dst - flag for whether the time zone somehow cares about daylight savings.
*/
