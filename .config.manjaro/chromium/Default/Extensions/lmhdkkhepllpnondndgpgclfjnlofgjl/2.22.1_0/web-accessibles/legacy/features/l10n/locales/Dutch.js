(function (global, factory) {
  ...
  ynabToolKit.l10nData = {
    ...
    "aria.checkName": "Controleer {{name}}",
    "aria.checkAllCategories": "Controleer alle categorieën",
    "aria.checkAllTransactions": "Controleer alle transacties",
    "aria.checkAllPayees": "Bekijk alle ontvangers",
    "aria.checkThisTransaction": "Verrichting nakijken",
    ...
    "modal.paymentOverspending": "Uw creditcard betaling was groter dan wat u in uw budget had.",
    ...
    "modal.movingThisReconciledTransaction": "Verwijderen van deze verzoende transactie brengt de verzoening uit balans.",
    ...
    "modal.directImportStatus.troubleshoot": "Probleemoplossing",
    "modal.directImportStatus.lastUpdated": "Laatst bijgewerkt op {{timeAgo}}",
    ...
    "modal.directImportStatus.delayed.details": "Deze verbinding is tijdelijk vertraagd, we blijven het proberen, probeer het later opnieuw!",
    ...
    "modal.directImportStatus.upgrade.details": "Update dit account voor verbeterde verbindingen of ga verder met een ontkoppeld account en update later.",
    "referralProgram.link": "Deel YNAB. Krijg YNAB Gratis.",
    ...
    "directImportUpgrade.updateThisAccount": "Deze Account bijwerken",
    ...
    "onboarding.set-goal.highlightCategory.description.alt": "Een oranje nummer in de kolom 'Beschikbaar' zal je gefocust houden tot je genoeg budgetteert om op koers te blijven. Dan zal het veranderen in Glorieus groen!<br/><br/>(Maar budgeteer er nog niet voor - Dat zal je in de volgende stap doen!)",
    "onboarding.set-goal.addAnother.description.alt": "Klik op OK om af te ronden, maar stop daar niet! Selecteer een andere categorie om uw volgende doel in te stellen – of dat nu de elektriciteitsrekening van volgende week is of sparen voor de huwelijksreis van volgend jaar!",
    "onboarding.set-goal.onCancelOrDelete.alt": "Al uw winkelen voor de komende negen verjaardagen en vakantie gedaan? Selecteer een andere categorie om een doel te stellen. Maar stel zeker een doel – we hebben ondervonden dat doelen de sleutel te zijn tot succesvol budgetteren!",
